  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-start gap-2 px-3 py-2 bg-terminal-yellow/5 border border-terminal-yellow/20 rounded text-xs text-terminal-yellow/80">
        ...
        Simulated results using Yahoo Finance 5m data (15-20 min delayed). One trade per day, first qualifying A/A+ setup in the 9:30–11:30 AM ET killzone. Past performance ≠ future results.
      </div>
